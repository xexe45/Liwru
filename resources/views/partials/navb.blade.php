<header class="header navegacion">
    <div class="sidebar-toggle-box">
        <div class="fa fa-bars tooltips desplegable" data-placement="right" data-original-title="Toggle Navigation"></div>
        <div class="arrow-before"></div>
    </div>
  <!--logo start-->
    <a href="index.html" class="logo">
            <img src="{{ asset('imgs/logo_blanco.png') }}" width="150px" alt="">
    </a>
  <!--logo end-->
  ...
  <div class="top-menu">
      <ul class="nav pull-right top-menu">
          ...
          <img src="{{ asset('imgs/logo_biblioteca2.png') }}" width="30px" alt="" class="imgtop">
      </ul>
  </div>
</header>